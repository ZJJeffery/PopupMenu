...
extension UIViewController {
    ...
    func pm_presentViewController(viewControllerToPresent: UIViewController, showFrame : CGRect, animationAppearBlock:(view: UIView,transitionContext: UIViewControllerContextTransitioning)->(),animationDisappearBlock:(view: UIView,transitionContext: UIViewControllerContextTransitioning)->(),completion: (() -> Void)?) {
